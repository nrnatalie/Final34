...
public class Main {
  ...
  public static void main(String[] args) {
    List<Final43.homework42.Book> books = new ArrayList<>();
    books.add(new Final43.homework42.Book("Пушкин", "Руслан и Людмила", 125));
    books.add(new Final43.homework42.Book("Пушкин", "Дубровский", 126));
